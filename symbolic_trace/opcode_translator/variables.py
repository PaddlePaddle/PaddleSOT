...
class VariableTrackerFactory:
    ...
    def from_value(value, graph): 
        ...
        return 
        raise RuntimeError(f"Don't Implement a value binding method for type: `{type(value)}`")
...
class ConstantVariable(VariableTracker): 
    ...
    def __mul__(self, other): 
        ...
        var = VariableTrackerFactory.from_value(self.value * other.value, self.graph)
        return var
